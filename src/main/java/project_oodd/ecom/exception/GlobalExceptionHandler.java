...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<ApiResponse<Map<String, Object>>> handleDataIntegrityViolation(DataIntegrityViolationException ex) {
	    ...
	    if (rootCause != null && rootCause.getMessage() != null) {
	        ...
	        if (rootMsg.contains("duplicate key")) {
	            ...
	            message = "Operation failed due to related data. Please remove references before deleting.";
    ...
    public ResponseEntity<ApiResponse<Map<String, Object>>> handleGenericException(Exception ex) {
    	...
    	ApiResponse<Map<String,Object>> response = new ApiResponse<>("error", "Something went wrong! Please contact service provider");
